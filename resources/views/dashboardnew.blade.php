                    ...
                    <div class="filter-group">
                        ...
                        <div class="filter-actions">
                            <button class="btn-apply" type="submit">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 15.803 7.5 7.5 0 0015.803 15.803z"/></svg>
                                Apply
                            </button>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card" style="animation-delay:.05s">
            <div class="stat-card-body">
                ...
                <div class="stat-value stat-value-blue">{{ $creditleft }}</div>
            </div>
                ...
                <div style="overflow-x:auto">
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr class="empty-row"><td colspan="2">No sales to report.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
            ...
            <div style="overflow-x:auto">
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr class="empty-row"><td colspan="2">You have no sales to report yet.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
