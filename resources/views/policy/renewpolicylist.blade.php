...
<x-layouts.app>
    ...
    <div class="modal fade" id="dynamicModal" tabindex="-1" aria-labelledby="dynamicModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('renew_policy') }}" method="post">
                    @csrf
    ...
    <script>
        ...
        modal.addEventListener('show.bs.modal', function(event) {
            ...
            const policyId = button.getAttribute('data-bs-toDelete');
            const policyIdInput = modal.querySelector('#policy_id');
            policyIdInput.value = policyId;
            modalBody.textContent = 'Begin Renewal '+ message + ' ?';
        });
    </script>
