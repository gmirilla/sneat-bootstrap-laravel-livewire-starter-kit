        ...
        @if ($errors->any())
            <div class="alert alert-danger" role="alert">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor" stroke-width="2" flex-shrink="0" style="flex-shrink:0;margin-top:1px">
                ...
                <div class="section-body">
                    <div class="fields-grid">
                        ...
                        <div class="field-group">
                            ...
                            <div class="field-value">{{ \Carbon\Carbon::parse($policy->start_date)->format('d M Y') }}
                            </div>
                        </div>
                        <div class="field-group">
                            <span class="field-label">Date To</span>
                            <div class="field-value">{{ \Carbon\Carbon::parse($policy->end_date)->format('d M Y') }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="section-body">
                    <div class="payment-section">
                        ...
                        @if (in_array($usercheck->role, ['agent', 'subagent', 'user']) && $agent->allowcredit == true && $creditleft > 0)
                            <div class="credit-banner">
                                ...
                                <div class="credit-banner-text">
                                    Agency credit available &mdash; you have <strong>{{ $creditleft }} upload
                                        credit{{ $creditleft == 1 ? '' : 's' }}</strong> remaining.
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="payment-methods">
                            ...
                            {{-- Paystack --}}
                            @if ($accesscode != null)
                                <button type="button" class="pay-btn pay-btn-paystack"
                                    onclick="paywithpaystack(event)" data-acode="{{ $accesscode }}"
                            ...
                            <button type="button" class="pay-btn pay-btn-moniepoint" disabled title="Coming soon">
                            ...
                            {{-- Agency Credit --}}
                            @if (in_array($usercheck->role, ['agent', 'subagent', 'user']) && $agent->allowcredit == true && $creditleft > 0)
                                <button type="button" class="pay-btn pay-btn-credit"
                                    onclick="showProcessingAndSubmit(this)" id="acreditbtn"
