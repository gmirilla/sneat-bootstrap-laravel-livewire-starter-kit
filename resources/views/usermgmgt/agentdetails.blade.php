                ...
                <form action="{{ route('agentupdate') }}" method="post">
                    ...
                    <div class="row gy-2 gx-3 align-items-center mb-3">
                        <div class="col-auto">
                            ...
                            @if (!empty($user->name))
                                <input type="text" class="form-control form-control-lg" name="agentname" disabled
                                    value="{{ $user->name }}">
                                <input type="text" class="form-control form-control-lg" name="userid" hidden
                                    value="{{ $user->id }}">
                            @else
                                <input type="text" class="form-control form-control-lg" name="agentname" disabled
                                    value="N/A. Please update User Record">
                            @endif
                        ...
                        <div class="col-auto">
                            ...
                            @if (!empty($user->name))
                                <input type="text" class="form-control form-control-lg" name="agentno" disabled
                                    value="{{ $user->telno }}">
                            @else
                                <input type="text" class="form-control form-control-lg" name="agentno" disabled
                                    value="N/A. Please update User Record">
                        ...
                        <div class="col-auto">
                            ...
                            <input type="text" class="form-control form-control-lg" name="authtoken"
                                value="{{ $agent->auth_token }}">
                        </div>

                        <div class="col-auto">
                            <label class='form-label' for="apitoken">API_TOKEN** (MOBILE APP)</label>
                            <input type="text" class="form-control form-control-lg" name="apitoken"
                                value="{{ $user->apitoken }}">
                        </div>
                        <div class="col-auto">
                            @php
                            ...
                            @endphp
                            <button type="button" class="btn btn-secondary" {{ $apigeneratebuttonstatus }}
                                onclick="generateApiToken()">Generate New API Token</button>
                            <button type="button" class="btn btn-danger" {{ $apirevokebuttonstatus }}
                                onclick="revokeApiToken()">Revoke API Token</button>
                        </div>
                        <div class="col-auto">
                            @if ($agent->allowcredit == true)
                                <input type="checkbox" class="form-check-input" name="agentcreditchk" checked
                                    value="allowed">
                                <label class='form-label form-check-label' for="agentcreditchk">Can buy on Credit
                                    ?</label>
                            @else
                                <input type="checkbox" class="form-check-input" name="agentcreditchk" value="false">
                                <label class='form-label form-check-label' for="agentcreditchk">Can buy on Credit
                                    ?</label>
                            @endif
                        </div>
                        ...
                        <div class="col-auto">
                            @if ($agent->canregistersubagent == true)
                                <input type="checkbox" class="form-check-input" name="agentregistersubagentchk" checked
                                    value="allowed">
                                <label class='form-label form-check-label' for="agentregistersubagentchk">Can register
                                    Sub Agents ?</label>
                            @else
                                <input type="checkbox" class="form-check-input" name="agentregistersubagentchk">
                                <label class='form-label form-check-label' for="agentregistersubagentchk">Can register
                                    Sub Agents ?</label>
                            @endif
                        </div>
