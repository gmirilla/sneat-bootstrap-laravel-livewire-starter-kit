...
<div class="container mt-5" style="max-width:480px">
    ...
    <div class="text-center mb-4">
        ...
        <p class="text-muted small">Enter your policy number and either the email address or phone number registered on the policy to continue.</p>
    </div>
            ...
            <form action="{{ route('claim.notify.lookup.post') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                           value="{{ old('email') }}" placeholder="e.g. you@example.com">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror"
                           value="{{ old('phone') }}" placeholder="e.g. +234555 1234567">
